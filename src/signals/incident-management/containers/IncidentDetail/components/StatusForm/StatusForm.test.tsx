...
describe('signals/incident-management/containers/IncidentDetail/components/StatusForm', () => {
  ...
  it('is not possible to submit the status Afgehandeld when category is Overig-Overig', async () => {
    ...
    configuration.featureFlags.disableClosingCategoryOverigOverig = true
  ...
  it('is possible to submit the status Afgehandeld when featureFlag disableClosingCategoryOverigOverig is false', async () => {
    ...
    configuration.featureFlags.disableClosingCategoryOverigOverig = false
  ...
  // eslint-disable-next-line jest/no-disabled-tests
  it.skip('shows an error notification when no email preview is available', async () => {
